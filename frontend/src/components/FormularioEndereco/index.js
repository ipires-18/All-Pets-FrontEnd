...
export default function FormularioCadastro(){
  ...
  async function handleFormEnd(e){
    ...
    if(resposta.status == 201){
      ...
      const valeuTime =  localStorage.getItem('valueTime');
              ...
              <form style={{margin:'30px 50px'}} onSubmit={handleFormEnd}>
                <section class="container-input-cad row">
                  <div class="item-input">
                    ...
                    <input defaultValue={cep} id="cep" type="text" placeholder="Digite o seu cep" value={cep} 
                    onChange={(e) => setCep(e.target.value)}/>
                  </div>
                  <div class="item-input">
                    <label htmlFor="estado" style={{display:'flex', justifyContent:'flex-start'}}>Estado</label>
                    <input defaultValue={state} id="estado" type="text" placeholder="Digite o seu estado" value={state}
                    onChange={(e) => setState(e.target.value)}/>
                  </div>
                  <div class="item-input">
                    <label htmlFor="cidade" style={{display:'flex', justifyContent:'flex-start'}}>Cidade</label>
                    <input defaultValue={city} id="cidade" type="text" placeholder="Digite sua cidade" value={city}
                    onChange={(e) => setCity(e.target.value)}/>
                  </div>
                  <div class="item-input">
                    <label htmlFor="cidade" style={{display:'flex', justifyContent:'flex-start'}}>Bairro</label>
                    <input defaultValue={bairro} id="cidade" type="text" placeholder="Digite seu bairro" value={bairro}
                  ...
                  <section class="container-input-cad row">
                    <div class="item-input">
                      ...
                      <input defaultValue={endereco} id="cidade" type="text" placeholder="Digite seu endereço" value={endereco}
                      onChange={(e) => setEndereco(e.target.value)}/>
                    </div> 
                    <div class="item-input">
                        <label htmlFor="cidade" style={{display:'flex', justifyContent:'flex-start'}}>Numero</label>
                        <input defaultValue={number} id="cidade" type="text" placeholder="Digite seu endereço" value={number}
                        onChange={(e) => setNumber(e.target.value)}/>
                    </div>
                    <div class="item-input">
                        <label htmlFor="cidade" style={{display:'flex', justifyContent:'flex-start'}}>Complemento</label>
                        <input defaultValue={complement} id="cidade" type="text" placeholder="Digite seu endereço" value={complement}
